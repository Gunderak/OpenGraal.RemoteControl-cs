...
namespace OpenGraal.GraalIM
{
	public class Framework
	{
		...
		public GraalServer GSConn;
		protected NCConnection NCConn;
		...
		*/
		...
		{
			return this.GSConn.PlayerManager.FindPlayer(Id);
		}
		...
		{
			return this.GSConn.PlayerManager.FindPlayer(Account);
		}
		...
		{
			return this.GSConn.PlayerManager.FindPlayer(pAccount, pId);
		}
	}
}
